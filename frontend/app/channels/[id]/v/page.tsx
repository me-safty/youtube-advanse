...
const page = async ({ params: { id } }: { params: { id: string } }) => {
	...
	// const [myRef, isVisable] = useInView()
	...
	return (
		<div className="">
			...
			{/* <p className="text-2xl" style={{ color: isVisable ? "#f00" : "#fff" }}>
				heloooo
			</p>
			<p className="text-2xl" style={{ color: isVisable ? "#f00" : "#fff" }}>
				heloooo
			...
			<p
				ref={myRef as unknown as React.LegacyRef<HTMLParagraphElement>}
				className="text-2xl"
				style={{ color: isVisable ? "#f00" : "#fff" }}
			>
				heloooo
			</p> */}
		</div>
